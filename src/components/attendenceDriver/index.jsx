  ...
  return (
    <div className="bg-white mt-5 py-4 rounded-xl px-3 xl:px-0">
      ...
      <div className="flex flex-col justify-center items-center mt-4 xl:mt-[-22px]">
        ...
        <img src={Branch1} alt="loading" className="mt-3 w-[68%] md:w-[40%] xl:w-1/4" />
        ...
        <div>
          <img src={Arrow2Up} alt="loading" className="mt-3 w-[68%] md:w-full mx-auto" />
        </div>
        <button className="mt-[9px] py-[11px] px-2.5 border border-[#E5E7EA] rounded-lg cursor-pointer">
        ...
        <div>
          <img src={Arrow2Down} alt="loading" className="mt-3 w-[68%] md:w-full mx-auto" />
        </div>
