		...
		<table class="progress-table table-auto w-full mt-4" id="progress-table">
			...
			<tbody className="w-full">
				<tr className="hover:bg-[#FFF] bg-[#FDFDFE] rounded-xl w-full customs-shadow" id="row1">
					...
					<td className="w-[15.3%] text-sm font-semibold text-[#FF8F6B] text-left px-2.5 py-6 border-r-[1px] border-[#F2F2F2]">
				...
				<tr className="hover:bg-[#FFF] bg-[#FDFDFE] rounded-xl w-full customs-shadow" id="row3">
					...
					<td className="w-[17.5%] text-sm font-semibold text-[#030229] text-left px-2.5 py-6 border-r-[1px] border-[#F2F2F2]">Arrora gaur</td>
					<td className="w-[15.3%] text-sm font-semibold text-[#FF8F6B] text-left px-2.5 py-6 border-r-[1px] border-[#F2F2F2] ">
						<button className="bg-[#FDF5E1]  text-[#FFD66B] px-2 py-0.5 rounded">Drying</button>
					</td>
				...
				<tr className="hover:bg-[#FFF] bg-[#FDFDFE] rounded-xl w-full customs-shadow" id="row4">
					...
					<td className="w-[17.5%] text-sm font-semibold text-[#030229] text-left px-2.5 py-6 border-r-[1px] border-[#F2F2F2]">Arrora gaur</td>
					<td className="w-[15.3%] text-sm font-semibold text-[#FF8F6B] text-left px-2.5 py-6 border-r-[1px] border-[#F2F2F2]">
						<button className="bg-[#D3ECF8]  text-[#2DAAE2] px-2 py-0.5 rounded">Folding Station</button>
					</td>
